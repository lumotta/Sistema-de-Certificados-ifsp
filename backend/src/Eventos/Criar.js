...
app.post("/criar-evento/confirmacao", async (req, res) => {
    ...
    try {
        await Evento.create({
            titulo: req.body.titulo, //Pega o valor do campo "titulo" do formulário enviado pelo cliente e atribui ao campo "titulo" do modelo "evento"
            descricao: req.body.descricao, //Pega o valor do campo "descricao" do formulário enviado pelo cliente e atribui ao campo "descricao" do modelo "evento"
            data_evento: req.body.data, //Pega o valor do campo "data" do formulário enviado pelo cliente e atribui ao campo "data" do modelo "evento"
            carga_horaria: req.body.carga_horaria //Pega o valor do campo "carga_horaria" do formulário enviado pelo cliente e atribui ao campo "carga_horaria" do modelo "evento"
